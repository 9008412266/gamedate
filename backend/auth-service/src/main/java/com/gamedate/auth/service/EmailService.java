package com.gamedate.auth.service;
...
public class EmailService {
    ...
    @Value("${app.mail.from:noreply@gamedate.app}")
    private String fromEmail;

    @Value("${app.frontend-url:https://gamedate.app}")
    private String frontendUrl;

    @Async
    public void sendVerificationEmail(String to, String username, String code) {
        String subject = "Verify your GameDate account";
        String html = """
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                  <h1 style="color: #FF6B9D;">Welcome to GameDate! 🎮❤️</h1>
                  ...
                  <hr/>
                  <p style="color: #888; font-size: 12px;">GameDate — Play Together, Connect Together</p>
                </div>
    ...
    public void sendPasswordResetEmail(String to, String username, String token) {
        ...
        String subject = "Reset your GameDate password";
        String html = """
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
